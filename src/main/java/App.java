...
public class App {
    ...
    public ResponseEntity<String> hello() {
        ...
        ".wrap{text-align:center;padding:40px;max-width:960px;width:100%;}" +
        ...
        "a.card{background:#112240;border:1px solid #233554;border-radius:12px;padding:22px 26px;min-width:160px;cursor:pointer;transition:transform .2s,border-color .2s;text-decoration:none;color:inherit;display:block;}" +
        "a.card:hover{transform:translateY(-8px);border-color:#00b4d8;box-shadow:0 8px 30px rgba(0,180,216,0.15);}" +
        ...
        ".click-hint{font-size:10px;color:#495670;margin-top:6px;}" +
